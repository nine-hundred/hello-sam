...
```bash
sam-multi-step$ sam logs -n StockCheckerFunction --stack-name sam-multi-step --tail
```
...
```bash
sam-multi-step$ go test -v ./functions/...
```
...
```bash
aws cloudformation delete-stack --stack-name sam-multi-step
```
